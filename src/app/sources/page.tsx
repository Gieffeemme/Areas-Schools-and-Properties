...
const SOURCES: { name: string; provider: string; licence: string }[] = [
  ...
  { name: "Street-level crime (England, Wales, NI)", provider: "police.uk / data.police.uk", licence: "OGL v3.0" },
  { name: "Recorded crime by council area (Scotland)", provider: "Scottish Government", licence: "OGL v3.0" },
  ...
  { name: "Amenities, stations, EV charging & base map data", provider: "OpenStreetMap contributors", licence: "ODbL (data) · tiles © CARTO / © Mapbox" },
