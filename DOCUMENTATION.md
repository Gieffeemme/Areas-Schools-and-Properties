...
|-------|:---:|:---:|:---:|:---:|
| School pins + phase | ✓ GIAS | ✓ Welsh register | ✗ | ✓ DE register |
| School Ofsted grade + DfE results | ✓ | ✗ (Estyn: no grade → My Local School) | ✗ | ✗ (ETI: no grade → DE Schools Plus) |
...
src/
  ...
  lib/   (one concern each)
    ...
    schools.ts      fetchSchools() / fetchSchoolsByIds() (GIAS+nurseries, URN-enriched; + Welsh & NI register pins, nation:"Wales"/"Northern Ireland"; runtime fs reads), searchSchools()
