...
src/
  app/
    ...
    api/
      area/route.ts            geocode + schools + crime + prices + amenities + transport + broadband + mobile + noise + air-quality + census → AreaReport (cached 6h)
...
- **Area panels:** **Area rankings** (national-percentile summary), **Who lives here** (Census 2021
  ...
  rail/metro/tram station, named — committed OSM dataset), **Broadband** (Ofcom coverage), **Mobile
